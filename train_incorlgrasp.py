...
def main():
    ...
    tf.summary.scalar(name='reward', tensor=tensorboard_reward)
    tf.summary.scalar(name='loss', tensor=tensorboard_loss)
    # q_summary = tf.summary.scalar(name='q', tensor=tensorboard_q)
    tf.summary.scalar(name='nb_success', tensor=tensorboard_nb_success)
    tf.summary.scalar(name='std_success', tensor=tensorboard_std_success)
